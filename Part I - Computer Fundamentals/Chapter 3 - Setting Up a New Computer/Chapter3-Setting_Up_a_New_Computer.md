## Chapter 3: Setting Up a New Computer

**Getting a new computer is exciting, but it can also feel overwhelming. This chapter will guide you through the entire process, from choosing the right computer for your needs to getting it fully configured and ready for daily use. These procedures are based on professional computer setup workflows used by experienced technicians.**
...
* **Primary Use Cases:**
    * Basic computing (web browsing, email, document editing)
    * Productivity work (Office applications, video calls, multitasking)
    * Content creation (photo editing, video editing, graphic design)
    * Gaming or entertainment
    * Professional applications (programming, CAD, data analysis)
* **Performance Expectations:**
    * **Basic Level:** Web browsing, email, simple Office tasks
    * **Mid-Range:** Multitasking, light content creation, business applications
...
| :--- | :--- | :--- |
| **Processor (CPU)** | Mid-range (Intel i5/AMD Ryzen 5 or better) | Higher-end CPUs are only needed for demanding tasks (gaming/video editing). |
| **Memory (RAM)** | **16GB** minimum (32GB+ for heavy use) | This is the minimum recommendation for smooth multitasking today. |
...
* **Laptop Considerations:**
    * Screen Size: 13" (portable) to 17"+ (desktop replacement)
    * All-in-one portability and built-in battery
    * Harder to repair and upgrade for the same cost
...
* **Under $800:** Basic computing needs
* **$800–$1200:** Mid-range performance, good for most users
* **$1200–$2000:** High-end performance, gaming, content creation
* **$2000+:** Professional workstations, extreme performance

*Budget Allocation Tip: Spend more on components that affect daily performance (SSD, adequate RAM) rather than flashy features you won't use.*
...
1.  Boot the new computer and begin the Windows 11 setup process.
2.  When prompted for an internet connection, use the advanced option to allow offline setup:
    * Press **Shift + F10** to open Command Prompt.
    * Type `OOBE\BYPASSNRO` and press **Enter**.
    * The system will restart and allow offline setup.
3.  Choose **"I don't have internet"** and accept the limited experience warning.
4.  Create a **local user account** matching your preferred username.
5.  Skip Microsoft account creation (you can add this later if needed).
...
1.  **Remove Bloatware:** New computers come with unnecessary software that slows performance.
    ...
    * Remove obvious junk programs, toolbars, and games (e.g., Candy Crush).
    * Remove manufacturer-specific software you don't need.
2.  **Windows Updates:**
    * Go to **Settings > Windows Update**.
    * Install all available updates and restart as needed.
    * Run **Microsoft Store Updates** as well.
3.  **Network Configuration:**
    * Set your network profile to **"Private"** for home/office networks.
    * Configure advanced sharing settings (e.g., turn on file and print sharing for private networks).
4.  **Essential System Settings:**
    * Configure user account password or PIN.
    * Set up Windows Hello (fingerprint/face recognition) if available.
...
2.  Add an account for each person who will use the computer.
3.  Choose account type:
    * **Administrator:** Can install software and change system settings.
    * **Standard User:** Safer for daily use, can't make system changes.
4.  Set up account security with strong passwords/PINs and two-factor authentication where possible.

*Professional Recommendation: Use a **standard user account** for daily activities and only switch to administrator when installing software or changing system settings. This reduces security risks from malware and accidental system changes.*
...
* **Anti-Malware Protection:**
    * **Windows Defender:** Built into Windows, adequate for most users.
    * **Malwarebytes:** Excellent supplementary anti-malware protection.
    * **ADWCleaner:** Removes adware and potentially unwanted programs.
...
* **Google Chrome:** Most popular, extensive extension library.
* **Mozilla Firefox:** Privacy-focused, open source.
* **Microsoft Edge:** Built into Windows, good performance.
* **Brave Browser:** Privacy-focused, blocks ads and trackers.
...
* **File Handling:** 7-Zip (compression), Sumatra PDF (lightweight, secure PDF viewer).
...
* Sign in with your Microsoft account during installation.
...
* **Desktop Configuration:** Recreate your preferred desktop icon layout, wallpaper, and themes.
...
* **Connectivity:** Internet browsing, email sending/receiving, printing, and network access.
...
* **Optimal Performance:** Your computer runs efficiently without bloatware.
* **Enhanced Security:** Essential security software is configured before connecting online.
* **User Productivity:** All essential software is installed and configured correctly.
* **Long-term Reliability:** Proper setup reduces future problems and maintenance needs.

**Key Takeaways:**

* Take time to assess your actual needs before purchasing.
* Use professional setup procedures like **OOBE bypass** for better control.
* Prioritize **security software** installation first.
* **Test everything** thoroughly before considering setup complete.
...
In [Chapter 4: Understanding Cyber Threats](Part%20II%20-%20Internet%20Safety%20%26%20Cybersecurity/Chapter%204%20-%20Understanding%20Cyber%20Threats/Chapter4-Understanding_Cyber_Threats.md), we'll explore internet safety and basic cybersecurity practices to keep your new computer and data protected from online threats.
