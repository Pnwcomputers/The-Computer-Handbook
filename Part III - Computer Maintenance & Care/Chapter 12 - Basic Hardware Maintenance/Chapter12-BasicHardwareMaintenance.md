...
* Cable management that actually improves performance
* When upgrading makes sense vs. buying new
* Signs your hardware needs professional attention
...
| :--- |
| **CPU:** Under $80^\circ\text{C}$ ($176^\circ\text{F}$) |
| **Graphics Card:** Under $85^\circ\text{C}$ ($185^\circ\text{F}$) |
| **Warning Sign:** Computer shuts down randomly or is hot to the touch. |
...
| Cleaning Guidelines (Safety First!) | What NOT to Do |
| :--- | :--- |
| **Support fans** while blowing air (prevents bearing damage). | Never use **vacuum cleaners** inside computers (static electricity risk). |
...
* **Route for Airflow:** Route cables behind the motherboard when possible. Use case tie points for organization.
...
| Component Upgrade | Cost-Effectiveness | DIY Difficulty | When It Makes Sense |
| :--- | :--- | :--- | :--- |
| **Storage (SSD)** | **High.** $50–$200. 3–10x faster boot/loading times. | Easy (SATA connection). | **Almost always worth it** regardless of computer age. |
| **Memory (RAM)** | **Medium.** $30–$100. Eliminates slowdowns from insufficient RAM. | Easy (snap-in installation). | If currently under 8GB for Windows 10/11. |
| **Graphics Card** | Medium/High. $150–$800+. Dramatic for gaming/editing. | Moderate. | If your current card can't run desired software/games. |
| **CPU Upgrade** | **Low.** Usually requires new motherboard and RAM. | Advanced/Not recommended. | **Rarely cost-effective.** New computer often better value. |

**Replacement Logic (Age):**

* **Age 0–3 Years:** Usually worth upgrading RAM, SSD, or Graphics.
* **Age 7+ Years:** Usually **not worth upgrading** (technology gap too large). Recommend starting replacement planning.
...
| :--- | :--- | :--- | :--- |
| **External Cleaning** | Monthly (15 min) | Wipe surfaces, clear vents with air, check for heat. | Temperatures consistently over $85^\circ\text{C}$ ($185^\circ\text{F}$). |
